          ...
          title: TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                borderSide: const BorderSide(color: Color(0xFFEBEBEB), width: 2.0),
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        'Акции и новости',
                        style: TextStyle(color: Color(0xFF939396), fontFamily: "Caption", fontWeight: FontWeight.w600, fontSize: 17),
                      ),
                      Text(
                        'Каталог анализов',
                        style: TextStyle(color: Color(0xFF939396), fontFamily: "Caption", fontWeight: FontWeight.w600, fontSize: 17),
                                ...
                                child: ElevatedButton(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text(
                                          'Популярное',
                                          style: TextStyle(
                                              color: Color(0xFFFFFFFF), fontFamily: "Caption", fontWeight: FontWeight.w600, fontSize: 15),
                                        ))),
                              ),
                              Container(
                                margin: EdgeInsets.fromLTRB(0, 0, 20, 0),
                                child: ElevatedButton(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        'Covid',
                                        style:
                                        TextStyle(color: Color(0xFF7E7E9A), fontFamily: "Caption", fontWeight: FontWeight.w600, fontSize: 15),
                                      ),
                                    )),
                              ),
                              Container(
